...
import net.amethyst.reworkedtools.magna.api.event.ToolMiningSpeedMultiplierCallback;
import net.amethyst.reworkedtools.magna.api.event.ToolRadiusCallback;
import net.amethyst.reworkedtools.magna.enchantment.CurseOfGigantismEnchantment;
